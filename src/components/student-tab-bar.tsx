...
const TABS = [
  ...
  { href: "/student/gallery", icon: "🖼", label: "Gallery", match: (p: string) => p.startsWith("/student/gallery") },
  { href: "/student/learn", icon: "📖", label: "Learn", match: (p: string) => p.startsWith("/student/learn") },
