...
export default async function TeacherBYOKPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#FFFDF7" }}>
      ...
      >
        <Link href="/teacher/dashboard" style={{ color: "#18B5A0" }} className="p-2 rounded-block">
      ...
      <main className="max-w-2xl mx-auto px-6 py-10 space-y-6">
        <div>
          ...
          <p className="font-sans mt-2" style={{ color: "#5C5747" }}>
            Connect your own free Google AI key to unlock higher daily limits for all students in your classrooms — same safety rules, no payment info ever.
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div className="font-sans text-sm mt-1" style={{ color: "#5C5747" }}>
              We store it encrypted with AES-256. It's never shown in full — only the last 4 characters — and students can't see it.
            </div>
          </div>
        </div>
